...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Order order1 = new Order(null, Instant.parse("2021-03-02T21:18:07Z"), user1);
		Order order2 = new Order(null, Instant.parse("2021-04-03T03:30:10Z"), user2);
		Order order3 = new Order(null, Instant.parse("2021-04-04T21:53:22Z"), user1);
